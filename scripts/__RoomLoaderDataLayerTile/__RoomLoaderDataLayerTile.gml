...
function __RoomLoaderDataLayerTile(
	_layerData,
	_elementsData
) : __RoomLoaderDataLayerParent(_layerData) constructor {
	// shared
	...
	static __OnLoadTransformed = function(
		_layer,
		_x,
		_y,
		_xScale,
		...
		if ((abs(_xScale) != 1) || (abs(_yScale) != 1)) {
			return;
		}

		var _tilemap = __CreateTilemapTransformed(
			_layer,
			_x,
			_y,
			_xScale,
	...
	static __CreateTilemapTransformed = function(
		_layer,
		_x,
		_y,
		_xScale,
		...
		switch (_angle) {
			...
			case 180: {
				...
				_mat00 = -1;
				_mat01 = 0;
				_rotXOffset = __width - 1;
				_mat10 = 0;
				_mat11 = -1;
				_rotYOffset = __height - 1;
